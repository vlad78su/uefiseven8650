  ...
  )
{
  ...
  ZeroMem ((VOID *)VGA_ROM_ADDRESS, sizeof (INT10H_HANDLER));
  ...
  if (EFI_ERROR (Status)) {
    ...
    PrintDebug (L"VESA shim ready. Int10h points to (%04x:%04x)\n",
      NewInt10hHandlerEntry.Segment, NewInt10hHandlerEntry.Offset);
  }
  CopyMem ((VOID *)(VGA_ROM_ADDRESS + 0x2000), AMD_VBIOS, sizeof (AMD_VBIOS));
